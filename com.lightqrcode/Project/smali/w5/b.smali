...
.method public static declared-synchronized a()Ljava/lang/ClassLoader;
    ...
    :try_start_0
    sget-object v1, Lw5/b;->a:Ljava/lang/ClassLoader;

    if-nez v1, :cond_0

    invoke-static {}, Lw5/b;->b()Ljava/lang/ClassLoader;

    move-result-object v1

    sput-object v1, Lw5/b;->a:Ljava/lang/ClassLoader;
...
.method private static declared-synchronized b()Ljava/lang/ClassLoader;
    ...
    :try_start_0
    sget-object v1, Lw5/b;->b:Ljava/lang/Thread;

    const/4 v2, 0x0

    if-nez v1, :cond_1

    invoke-static {}, Lw5/b;->c()Ljava/lang/Thread;

    move-result-object v1

    sput-object v1, Lw5/b;->b:Ljava/lang/Thread;
    ...
    :try_start_2
    sget-object v3, Lw5/b;->b:Ljava/lang/Thread;
...
.method private static declared-synchronized c()Ljava/lang/Thread;
    ...
    invoke-direct {v1, v8, v4}, Lw5/a;-><init>(Ljava/lang/ThreadGroup;Ljava/lang/String;)V
    :try_end_3
