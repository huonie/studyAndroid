...
# direct methods
.method synthetic constructor <init>(Lcom/android/billingclient/api/b;Lj2/c;Lj2/l;)V
    .locals 0
    ...
    iput-object p2, p0, Lcom/android/billingclient/api/o;->c:Lj2/c;
...
.method private final d(Lcom/android/billingclient/api/d;)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/billingclient/api/o;->c:Lj2/c;

    if-eqz v1, :cond_0

    invoke-interface {v1, p1}, Lj2/c;->a(Lcom/android/billingclient/api/d;)V
...
.method final synthetic a()Ljava/lang/Object;
    ...
    invoke-static {v4}, Lcom/android/billingclient/api/b;->w(Lcom/android/billingclient/api/b;)Landroid/content/Context;
    ...
    invoke-static {v8}, Lcom/android/billingclient/api/b;->C(Lcom/android/billingclient/api/b;)Lf6/n;

    move-result-object v8

    const-string v9, "subs"

    invoke-interface {v8, v6, v4, v9}, Lf6/n;->i1(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-interface {v8, v6, v4, v9, v0}, Lf6/n;->M3(ILjava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    :goto_5
    invoke-static {v8, v9}, Lcom/android/billingclient/api/b;->n(Lcom/android/billingclient/api/b;Z)V
    ...
    invoke-static {v6, v8}, Lf6/k;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v6}, Lcom/android/billingclient/api/b;->I(Lcom/android/billingclient/api/b;I)V
    ...
    :goto_9
    invoke-static {v0, v4}, Lcom/android/billingclient/api/b;->O(Lcom/android/billingclient/api/b;Z)V
    ...
    :goto_10
    invoke-static {v0, v4}, Lcom/android/billingclient/api/b;->Q(Lcom/android/billingclient/api/b;Z)V
    ...
    :goto_11
    invoke-static {v0, v10}, Lcom/android/billingclient/api/b;->P(Lcom/android/billingclient/api/b;Z)V
    ...
    invoke-static {v0, v1}, Lf6/k;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3}, Lcom/android/billingclient/api/b;->H(Lcom/android/billingclient/api/b;I)V

    iget-object v0, p0, Lcom/android/billingclient/api/o;->d:Lcom/android/billingclient/api/b;

    invoke-static {v0, v2}, Lcom/android/billingclient/api/b;->l(Lcom/android/billingclient/api/b;Lf6/n;)V
    :try_end_2
    ...
    invoke-static {v4, v5, v0}, Lf6/k;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method final synthetic b()V
    ...
    invoke-static {v0, v1}, Lcom/android/billingclient/api/b;->l(Lcom/android/billingclient/api/b;Lf6/n;)V
...
.method final c()V
    ...
    :try_start_0
    iput-object v1, p0, Lcom/android/billingclient/api/o;->c:Lj2/c;
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-static {p1, v0}, Lf6/k;->l(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/android/billingclient/api/o;->d:Lcom/android/billingclient/api/b;

    invoke-static {p2}, Lf6/m;->L(Landroid/os/IBinder;)Lf6/n;

    move-result-object p2

    invoke-static {p1, p2}, Lcom/android/billingclient/api/b;->l(Lcom/android/billingclient/api/b;Lf6/n;)V
    ...
    invoke-static {v0}, Lcom/android/billingclient/api/b;->z(Lcom/android/billingclient/api/b;)Landroid/os/Handler;

    move-result-object v5

    const-wide/16 v2, 0x7530

    invoke-static/range {v0 .. v5}, Lcom/android/billingclient/api/b;->G(Lcom/android/billingclient/api/b;Ljava/util/concurrent/Callable;JLjava/lang/Runnable;Landroid/os/Handler;)Ljava/util/concurrent/Future;
    ...
    invoke-static {p1}, Lcom/android/billingclient/api/b;->A(Lcom/android/billingclient/api/b;)Lcom/android/billingclient/api/d;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/android/billingclient/api/o;->d(Lcom/android/billingclient/api/d;)V
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    invoke-static {p1, v0}, Lcom/android/billingclient/api/b;->l(Lcom/android/billingclient/api/b;Lf6/n;)V

    iget-object p1, p0, Lcom/android/billingclient/api/o;->d:Lcom/android/billingclient/api/b;

    const/4 v0, 0x0

    invoke-static {p1, v0}, Lcom/android/billingclient/api/b;->H(Lcom/android/billingclient/api/b;I)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/billingclient/api/o;->c:Lj2/c;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lj2/c;->b()V
