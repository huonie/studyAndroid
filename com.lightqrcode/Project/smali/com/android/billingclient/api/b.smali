...
.field private volatile d:Lcom/android/billingclient/api/u;

.field private e:Landroid/content/Context;

.field private volatile f:Lf6/n;
...
# direct methods
.method private constructor <init>(Landroid/content/Context;ZLj2/h;Ljava/lang/String;Ljava/lang/String;Lj2/e0;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p3, p2, p4}, Lcom/android/billingclient/api/b;->i(Landroid/content/Context;Lj2/h;ZLj2/e0;)V

    return-void
.end method

.method constructor <init>(Ljava/lang/String;ZLandroid/content/Context;Lj2/h;Lj2/e0;)V
    .locals 7

    invoke-static {}, Lcom/android/billingclient/api/b;->s()Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/billingclient/api/b;-><init>(Landroid/content/Context;ZLj2/h;Ljava/lang/String;Ljava/lang/String;Lj2/e0;)V

    return-void
.end method

.method constructor <init>(Ljava/lang/String;ZLandroid/content/Context;Lj2/w;)V
    .locals 1
    ...
    invoke-direct {p3, p1, p4}, Lcom/android/billingclient/api/u;-><init>(Landroid/content/Context;Lj2/w;)V

    iput-object p3, p0, Lcom/android/billingclient/api/b;->d:Lcom/android/billingclient/api/u;
...
.method static bridge synthetic A(Lcom/android/billingclient/api/b;)Lcom/android/billingclient/api/d;
    .locals 0

    invoke-direct {p0}, Lcom/android/billingclient/api/b;->r()Lcom/android/billingclient/api/d;
...
.method static bridge synthetic B(Lcom/android/billingclient/api/b;Ljava/lang/String;)Lj2/x;
    .locals 13
    ...
    invoke-static {v1, v0}, Lf6/k;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v3, v4}, Lf6/k;->g(ZZLjava/lang/String;)Landroid/os/Bundle;
    ...
    iget-object v5, p0, Lcom/android/billingclient/api/b;->f:Lf6/n;
    ...
    invoke-interface/range {v5 .. v10}, Lf6/n;->i4(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/billingclient/api/b;->f:Lf6/n;

    const/4 v5, 0x3

    iget-object v6, p0, Lcom/android/billingclient/api/b;->e:Landroid/content/Context;

    invoke-virtual {v6}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v6

    invoke-interface {v4, v5, v6, p1, v9}, Lf6/n;->U3(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    new-instance p0, Lj2/x;

    invoke-direct {p0, v5, v3}, Lj2/x;-><init>(Lcom/android/billingclient/api/d;Ljava/util/List;)V
    ...
    invoke-static {v1, v11}, Lf6/k;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v9}, Lf6/k;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, p1, p0}, Lf6/k;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    new-instance p0, Lj2/x;

    sget-object p1, Lcom/android/billingclient/api/p;->j:Lcom/android/billingclient/api/d;

    invoke-direct {p0, p1, v3}, Lj2/x;-><init>(Lcom/android/billingclient/api/d;Ljava/util/List;)V
    ...
    invoke-static {v1, v4}, Lf6/k;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v0}, Lj2/x;-><init>(Lcom/android/billingclient/api/d;Ljava/util/List;)V
...
.method static bridge synthetic C(Lcom/android/billingclient/api/b;)Lf6/n;
    .locals 0

    iget-object p0, p0, Lcom/android/billingclient/api/b;->f:Lf6/n;

    return-object p0
.end method

.method static bridge synthetic G(Lcom/android/billingclient/api/b;Ljava/util/concurrent/Callable;JLjava/lang/Runnable;Landroid/os/Handler;)Ljava/util/concurrent/Future;
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/billingclient/api/b;->t(Ljava/util/concurrent/Callable;JLjava/lang/Runnable;Landroid/os/Handler;)Ljava/util/concurrent/Future;
...
.method static bridge synthetic I(Lcom/android/billingclient/api/b;I)V
    .locals 0
...
.method private i(Landroid/content/Context;Lj2/h;ZLj2/e0;)V
    .locals 1
    ...
    invoke-direct {v0, p1, p2, p4}, Lcom/android/billingclient/api/u;-><init>(Landroid/content/Context;Lj2/h;Lj2/e0;)V

    iput-object v0, p0, Lcom/android/billingclient/api/b;->d:Lcom/android/billingclient/api/u;
...
.method static bridge synthetic l(Lcom/android/billingclient/api/b;Lf6/n;)V
    .locals 0

    iput-object p1, p0, Lcom/android/billingclient/api/b;->f:Lf6/n;
...
.method private final q(Lcom/android/billingclient/api/d;)Lcom/android/billingclient/api/d;
    .locals 2
...
.method private final r()Lcom/android/billingclient/api/d;
    .locals 2
...
.method private final t(Ljava/util/concurrent/Callable;JLjava/lang/Runnable;Landroid/os/Handler;)Ljava/util/concurrent/Future;
    ...
    invoke-direct {v0, p1, p4}, Lj2/k;-><init>(Ljava/util/concurrent/Future;Ljava/lang/Runnable;)V
    ...
    invoke-static {p2, p3, p1}, Lf6/k;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final u(Ljava/lang/String;Lj2/g;)V
    .locals 7
    ...
    invoke-interface {p2, p1, v0}, Lj2/g;->a(Lcom/android/billingclient/api/d;Ljava/util/List;)V
    ...
    invoke-direct {v2, p0, p1, p2}, Lcom/android/billingclient/api/k;-><init>(Lcom/android/billingclient/api/b;Ljava/lang/String;Lj2/g;)V

    new-instance v5, Lcom/android/billingclient/api/i;

    invoke-direct {v5, p2}, Lcom/android/billingclient/api/i;-><init>(Lj2/g;)V

    const-wide/16 v3, 0x7530

    invoke-direct {p0}, Lcom/android/billingclient/api/b;->p()Landroid/os/Handler;

    move-result-object v6

    move-object v1, p0

    invoke-direct/range {v1 .. v6}, Lcom/android/billingclient/api/b;->t(Ljava/util/concurrent/Callable;JLjava/lang/Runnable;Landroid/os/Handler;)Ljava/util/concurrent/Future;
...
.method static bridge synthetic w(Lcom/android/billingclient/api/b;)Landroid/content/Context;
    .locals 0
...
.method static bridge synthetic z(Lcom/android/billingclient/api/b;)Landroid/os/Handler;
    .locals 0
...
# virtual methods
.method final synthetic D(Lj2/a;Lj2/b;)Ljava/lang/Object;
    .locals 7
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/billingclient/api/b;->f:Lf6/n;
    ...
    invoke-static {p1, v6}, Lf6/k;->c(Lj2/a;Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object p1

    invoke-interface {v2, v3, v4, v5, p1}, Lf6/n;->f5(ILjava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object p1
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    invoke-static {p1, v0}, Lf6/k;->b(Landroid/os/Bundle;Ljava/lang/String;)I

    move-result v2

    invoke-static {p1, v0}, Lf6/k;->i(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    invoke-interface {p2, p1}, Lj2/b;->a(Lcom/android/billingclient/api/d;)V
    ...
    invoke-static {v0, v2, p1}, Lf6/k;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method final synthetic E(Lj2/d;Lj2/e;)Ljava/lang/Object;
    .locals 7

    const-string v0, "BillingClient"

    invoke-virtual {p1}, Lj2/d;->a()Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lf6/k;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v5, p0, Lcom/android/billingclient/api/b;->m:Z

    iget-object v6, p0, Lcom/android/billingclient/api/b;->b:Ljava/lang/String;

    invoke-static {p1, v5, v6}, Lf6/k;->d(Lj2/d;ZLjava/lang/String;)Landroid/os/Bundle;

    move-result-object p1

    invoke-interface {v2, v3, v4, v1, p1}, Lf6/n;->A1(ILjava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/billingclient/api/b;->f:Lf6/n;
    ...
    invoke-interface {p1, v2, v3, v1}, Lf6/n;->k1(ILjava/lang/String;Ljava/lang/String;)I
    ...
    :goto_1
    invoke-interface {p2, p1, v1}, Lj2/e;->a(Lcom/android/billingclient/api/d;Ljava/lang/String;)V
    ...
    invoke-static {v0, v2}, Lf6/k;->m(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method final synthetic F(Lcom/android/billingclient/api/f;Lj2/f;)Ljava/lang/Object;
    .locals 19
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/android/billingclient/api/f;->b()Lf6/b0;
    ...
    :try_start_0
    iget-object v4, v1, Lcom/android/billingclient/api/b;->f:Lf6/n;
    ...
    invoke-static {v5, v6, v15}, Lf6/k;->f(Ljava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-interface/range {v4 .. v9}, Lf6/n;->e1(ILjava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :goto_3
    invoke-static {v2, v0}, Lf6/k;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v2}, Lf6/k;->b(Landroid/os/Bundle;Ljava/lang/String;)I

    move-result v12

    invoke-static {v4, v2}, Lf6/k;->i(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v6}, Lf6/k;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v4, v0}, Lf6/k;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v14}, Lcom/android/billingclient/api/d$a;->b(Ljava/lang/String;)Lcom/android/billingclient/api/d$a;
    ...
    invoke-interface {v2, v0, v3}, Lj2/f;->a(Lcom/android/billingclient/api/d;Ljava/util/List;)V

    return-object v15
.end method

.method public final a(Lj2/a;Lj2/b;)V
    .locals 6
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/billingclient/api/z;-><init>(Lcom/android/billingclient/api/b;Lj2/a;Lj2/b;)V

    new-instance v4, Lcom/android/billingclient/api/a0;

    invoke-direct {v4, p2}, Lcom/android/billingclient/api/a0;-><init>(Lj2/b;)V
...
.method public final b(Lj2/d;Lj2/e;)V
    .locals 7
    ...
    invoke-interface {p2, v0, p1}, Lj2/e;->a(Lcom/android/billingclient/api/d;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, p1, p2}, Lcom/android/billingclient/api/x;-><init>(Lcom/android/billingclient/api/b;Lj2/d;Lj2/e;)V

    new-instance v5, Lcom/android/billingclient/api/y;

    invoke-direct {v5, p2, p1}, Lcom/android/billingclient/api/y;-><init>(Lj2/e;Lj2/d;)V
...
.method public final c()V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/billingclient/api/b;->d:Lcom/android/billingclient/api/u;

    invoke-virtual {v2}, Lcom/android/billingclient/api/u;->d()V

    iget-object v2, p0, Lcom/android/billingclient/api/b;->g:Lcom/android/billingclient/api/o;
    ...
    iget-object v4, p0, Lcom/android/billingclient/api/b;->g:Lcom/android/billingclient/api/o;

    invoke-virtual {v2, v4}, Landroid/content/Context;->unbindService(Landroid/content/ServiceConnection;)V

    iput-object v3, p0, Lcom/android/billingclient/api/b;->g:Lcom/android/billingclient/api/o;

    :cond_1
    iput-object v3, p0, Lcom/android/billingclient/api/b;->f:Lf6/n;

    iget-object v2, p0, Lcom/android/billingclient/api/b;->v:Ljava/util/concurrent/ExecutorService;

    if-eqz v2, :cond_2

    invoke-interface {v2}, Ljava/util/concurrent/ExecutorService;->shutdownNow()Ljava/util/List;

    iput-object v3, p0, Lcom/android/billingclient/api/b;->v:Ljava/util/concurrent/ExecutorService;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, v3, v2}, Lf6/k;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
...
.method public final d(Landroid/app/Activity;Lcom/android/billingclient/api/c;)Lcom/android/billingclient/api/d;
    ...
    :goto_1
    invoke-direct {v8, v0}, Lcom/android/billingclient/api/b;->q(Lcom/android/billingclient/api/d;)Lcom/android/billingclient/api/d;
    ...
    invoke-static {v2, v4}, Lf6/g0;->a(Ljava/lang/Iterable;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lcom/android/billingclient/api/SkuDetails;

    invoke-static {v3, v4}, Lf6/g0;->a(Ljava/lang/Iterable;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v12, v0}, Lf6/k;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v13, v11, v14, v15, v4}, Lf6/k;->e(Lcom/android/billingclient/api/c;ZZZLjava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-virtual {v10}, Lcom/android/billingclient/api/e;->e()Ljava/lang/String;
    ...
    invoke-static {v9, v0}, Lf6/k;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v9}, Lf6/k;->b(Landroid/os/Bundle;Ljava/lang/String;)I

    move-result v1

    invoke-static {v0, v9}, Lf6/k;->i(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v9, v1, v0}, Lf6/k;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public f(Lcom/android/billingclient/api/f;Lj2/f;)V
    .locals 7
    ...
    :goto_0
    invoke-interface {p2, p1, v0}, Lj2/f;->a(Lcom/android/billingclient/api/d;Ljava/util/List;)V
    ...
    invoke-direct {v2, p0, p1, p2}, Lcom/android/billingclient/api/v;-><init>(Lcom/android/billingclient/api/b;Lcom/android/billingclient/api/f;Lj2/f;)V

    new-instance v5, Lcom/android/billingclient/api/w;

    invoke-direct {v5, p2}, Lcom/android/billingclient/api/w;-><init>(Lj2/f;)V
...
.method public g(Lj2/i;Lj2/g;)V
    .locals 0

    invoke-virtual {p1}, Lj2/i;->b()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1, p2}, Lcom/android/billingclient/api/b;->u(Ljava/lang/String;Lj2/g;)V

    return-void
.end method

.method public final h(Lj2/c;)V
    .locals 7
    ...
    invoke-interface {p1, v0}, Lj2/c;->a(Lcom/android/billingclient/api/d;)V
    ...
    invoke-static {v1, v0}, Lf6/k;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/b;->d:Lcom/android/billingclient/api/u;

    invoke-virtual {v0}, Lcom/android/billingclient/api/u;->e()V
    ...
    invoke-direct {v0, p0, p1, v3}, Lcom/android/billingclient/api/o;-><init>(Lcom/android/billingclient/api/b;Lj2/c;Lj2/l;)V
    ...
    invoke-static {v1, p1}, Lf6/k;->l(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final j()Z
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/b;->f:Lf6/n;
...
.method final synthetic o(Lcom/android/billingclient/api/d;)V
    .locals 2

    iget-object v0, p0, Lcom/android/billingclient/api/b;->d:Lcom/android/billingclient/api/u;

    invoke-virtual {v0}, Lcom/android/billingclient/api/u;->c()Lj2/h;
    ...
    invoke-interface {v0, p1, v1}, Lj2/h;->a(Lcom/android/billingclient/api/d;Ljava/util/List;)V

    return-void

    :cond_0
    iget-object p1, p0, Lcom/android/billingclient/api/b;->d:Lcom/android/billingclient/api/u;

    invoke-virtual {p1}, Lcom/android/billingclient/api/u;->b()Lj2/w;
...
.method final synthetic x(ILjava/lang/String;Ljava/lang/String;Lcom/android/billingclient/api/c;Landroid/os/Bundle;)Landroid/os/Bundle;
    .locals 7
    ...
    invoke-interface/range {v0 .. v6}, Lf6/n;->Q1(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method final synthetic y(Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-interface/range {v0 .. v5}, Lf6/n;->m4(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
