...
.method protected M(Lk0/c;)V
    ...
    invoke-virtual {p1, v0}, Lk0/c;->U(Z)V
    ...
    invoke-virtual {p1, v0}, Lk0/c;->X(Z)V
    ...
    :goto_0
    invoke-virtual {p1, v0}, Lk0/c;->W(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lk0/c;->s0(Ljava/lang/CharSequence;)V

    goto :goto_3

    :cond_3
    invoke-virtual {p1, v0}, Lk0/c;->a0(Ljava/lang/CharSequence;)V

    :goto_3
    return-void
.end method

.method protected N(ILk0/c;)V
    .locals 6
    ...
    :goto_0
    invoke-virtual {p2, p1}, Lk0/c;->a0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, Lk0/c;->S(Landroid/graphics/Rect;)V

    sget-object p1, Lk0/c$a;->i:Lk0/c$a;
    ...
    invoke-virtual {p2, p1}, Lk0/c;->c0(Z)V

    goto :goto_2

    :cond_2
    invoke-virtual {p2, v0}, Lk0/c;->a0(Ljava/lang/CharSequence;)V
