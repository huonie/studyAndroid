...
.field private final f:Le7/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILe7/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Le7/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v1, v2}, Lj0/h;->a(ZLjava/lang/Object;)V

    sget-object v1, Ln6/k;->J2:[I
    ...
    invoke-static {p0, p1, v1}, Lb7/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, Le7/k;->b(Landroid/content/Context;II)Le7/k$b;

    move-result-object p0

    invoke-virtual {p0}, Le7/k$b;->m()Le7/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILe7/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Le7/k;

    invoke-virtual {v0, v2}, Le7/g;->setShapeAppearanceModel(Le7/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Le7/k;

    invoke-virtual {v1, v2}, Le7/g;->setShapeAppearanceModel(Le7/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Le7/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/a0;->v0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
