...
.method private d(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, Lf/b;->y:Lf/b$c;
    ...
    iput-object v0, p0, Lf/b;->y:Lf/b$c;
    ...
    :try_start_0
    iget-object v0, p0, Lf/b;->n:Lf/b$d;
    ...
    invoke-static {p1, v1}, Lc0/a;->m(Landroid/graphics/drawable/Drawable;I)Z
    ...
    iget-object v1, p0, Lf/b;->n:Lf/b$d;

    iget-boolean v1, v1, Lf/b$d;->C:Z

    invoke-static {p1, v1}, Lc0/a;->j(Landroid/graphics/drawable/Drawable;Z)V

    :cond_6
    iget-object v1, p0, Lf/b;->o:Landroid/graphics/Rect;
    ...
    invoke-static {p1, v0, v2, v3, v1}, Lc0/a;->l(Landroid/graphics/drawable/Drawable;IIII)V
    :try_end_0
    ...
    iget-object v1, p0, Lf/b;->y:Lf/b$c;
...
.method a(Z)V
    ...
    iget-object v3, p0, Lf/b;->p:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v9, p0, Lf/b;->n:Lf/b$d;
    ...
    :cond_1
    :goto_0
    iput-wide v7, p0, Lf/b;->w:J

    :cond_2
    const/4 v3, 0x0

    :goto_1
    iget-object v9, p0, Lf/b;->q:Landroid/graphics/drawable/Drawable;

    if-eqz v9, :cond_4

    iget-wide v10, p0, Lf/b;->x:J
    ...
    iput-object v0, p0, Lf/b;->q:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, Lf/b;->n:Lf/b$d;
    ...
    iget-object p1, p0, Lf/b;->v:Ljava/lang/Runnable;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lf/b;->p:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v0, p0, Lf/b;->q:Landroid/graphics/drawable/Drawable;
...
.method g(I)Z
    ...
    iput-wide v0, p0, Lf/b;->x:J

    goto :goto_0

    :cond_2
    iput-object v4, p0, Lf/b;->q:Landroid/graphics/drawable/Drawable;

    iput-wide v5, p0, Lf/b;->x:J
    ...
    iput-object v0, p0, Lf/b;->p:Landroid/graphics/drawable/Drawable;

    iput p1, p0, Lf/b;->t:I

    if-eqz v0, :cond_7

    iget-object p1, p0, Lf/b;->n:Lf/b$d;
    ...
    :cond_6
    iput-object v4, p0, Lf/b;->p:Landroid/graphics/drawable/Drawable;
    ...
    :cond_8
    iget-object v0, p0, Lf/b;->v:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lf/b;->v:Ljava/lang/Runnable;
...
.method public getHotspotBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lf/b;->o:Landroid/graphics/Rect;
...
.method h(Lf/b$d;)V
    ...
    iput-object p1, p0, Lf/b;->n:Lf/b$d;
    ...
    iput-object p1, p0, Lf/b;->p:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Lf/b;->q:Landroid/graphics/drawable/Drawable;
...
.method public jumpToCurrentState()V
    ...
    :goto_0
    iget-object v2, p0, Lf/b;->p:Landroid/graphics/drawable/Drawable;
    ...
    iput-wide v4, p0, Lf/b;->x:J

    const/4 v0, 0x1

    :cond_2
    iget-wide v2, p0, Lf/b;->w:J

    cmp-long v6, v2, v4

    if-eqz v6, :cond_3

    iput-wide v4, p0, Lf/b;->w:J
...
.method public setHotspotBounds(IIII)V
    ...
    iput-object v0, p0, Lf/b;->o:Landroid/graphics/Rect;
...
.method public setVisible(ZZ)Z
    ...
    iget-object v1, p0, Lf/b;->q:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Lf/b;->p:Landroid/graphics/drawable/Drawable;
