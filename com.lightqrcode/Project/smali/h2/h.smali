...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lh2/h;->a:Ljava/lang/ThreadLocal;

    new-instance v0, Lh2/h$b;

    invoke-direct {v0}, Lh2/h$b;-><init>()V

    sput-object v0, Lh2/h;->b:Ljava/lang/ThreadLocal;

    new-instance v0, Lh2/h$c;

    invoke-direct {v0}, Lh2/h$c;-><init>()V

    sput-object v0, Lh2/h;->c:Ljava/lang/ThreadLocal;

    new-instance v0, Lh2/h$d;

    invoke-direct {v0}, Lh2/h$d;-><init>()V

    sput-object v0, Lh2/h;->d:Ljava/lang/ThreadLocal;
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    sget-object v1, Lh2/h;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, Lh2/h;->b:Ljava/lang/ThreadLocal;
    ...
    sget-object v3, Lh2/h;->c:Ljava/lang/ThreadLocal;
    ...
    invoke-static {v5, v4}, Lh2/g;->g(FF)I

    move-result p2

    int-to-float v5, p2

    invoke-static {p1, v4}, Lh2/g;->g(FF)I
...
.method public static b(Landroid/graphics/Path;Lx1/s;)V
    .locals 3

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lx1/s;->l()Z
    ...
    :cond_0
    invoke-virtual {p1}, Lx1/s;->j()Ly1/a;
    ...
    invoke-virtual {p1}, Lx1/s;->f()Ly1/a;
    ...
    invoke-virtual {p1}, Lx1/s;->i()Ly1/a;

    move-result-object p1

    check-cast p1, Ly1/c;

    invoke-virtual {p1}, Ly1/c;->p()F
    ...
    invoke-static {p0, v0, v1, p1}, Lh2/h;->a(Landroid/graphics/Path;FFF)V
...
.method public static g(Landroid/graphics/Matrix;)F
    ...
    sget-object v0, Lh2/h;->d:Ljava/lang/ThreadLocal;
...
.method public static m(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lh2/h;->n(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
