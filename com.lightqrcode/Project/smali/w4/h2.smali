...
.method public static F5(Landroid/os/IBinder;)Lw4/i2;
    .locals 2
    ...
    :cond_1
    new-instance v0, Lw4/g2;

    invoke-direct {v0, p0}, Lw4/g2;-><init>(Landroid/os/IBinder;)V
...
.method protected final E5(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :pswitch_0
    invoke-interface {p0}, Lw4/i2;->m()V

    goto/16 :goto_3

    :pswitch_1
    invoke-interface {p0}, Lw4/i2;->o()Z
    ...
    :pswitch_3
    invoke-interface {p0}, Lw4/i2;->k()Z
    ...
    :pswitch_4
    invoke-interface {p0}, Lw4/i2;->c()F
    ...
    :cond_1
    new-instance p4, Lw4/j2;

    invoke-direct {p4, p1}, Lw4/j2;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-interface {p0, p1}, Lw4/i2;->I1(Lw4/l2;)V

    goto :goto_3

    :pswitch_6
    invoke-interface {p0}, Lw4/i2;->d()F
    ...
    :pswitch_7
    invoke-interface {p0}, Lw4/i2;->g()F
    ...
    :pswitch_8
    invoke-interface {p0}, Lw4/i2;->f()I
    ...
    :pswitch_9
    invoke-interface {p0}, Lw4/i2;->t()Z
    ...
    invoke-interface {p0, p1}, Lw4/i2;->X2(Z)V

    goto :goto_3

    :pswitch_b
    invoke-interface {p0}, Lw4/i2;->j()V

    goto :goto_3

    :pswitch_c
    invoke-interface {p0}, Lw4/i2;->l()V
