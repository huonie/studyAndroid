...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ll5/j;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ll5/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static b(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Ll5/b;->W0(I)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Ll5/k;->a(Landroid/content/Context;)Ll5/k;

    if-eqz v0, :cond_0

    invoke-static {v0, v1}, Ll5/k;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Ll5/k;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Ll5/j;->c:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Ll5/j;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Ll5/j;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, Lt5/j;->e()Z
...
.method public static f(Landroid/content/Context;I)I
    ...
    sget-object v1, Ll5/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    invoke-static {p0}, Lp5/s0;->a(Landroid/content/Context;)I
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, Lt5/j;->g(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lt5/j;->i(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v3}, Ll5/k;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Ll5/k;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lt5/t;->a(I)I

    move-result p0

    invoke-static {p1}, Lt5/t;->a(I)I
...
.method public static g(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ll5/j;->k(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static j(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Lt5/s;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method static k(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Ll5/j;->h(Landroid/content/Context;)Z
