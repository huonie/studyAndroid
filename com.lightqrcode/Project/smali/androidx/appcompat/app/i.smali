...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/i;->h:Lq/g;
...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/a0;->s0(Landroid/view/View;Z)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/a0;->u0(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p2, p3}, Landroidx/core/view/a0;->F0(Landroid/view/View;Z)V
...
.method private s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroidx/appcompat/app/i;->h:Lq/g;
...
.method protected f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    .locals 1
...
.method protected p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/a0;
    .locals 1
...
.method final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatEditText;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/a0;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/w;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/m;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/o;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
