...
.field final synthetic a0:Landroidx/appcompat/widget/w;
...
.method public constructor <init>(Landroidx/appcompat/widget/w;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/w$e;->Y:Landroid/graphics/Rect;
...
.method static synthetic R(Landroidx/appcompat/widget/w$e;)V
    ...
    invoke-super {p0}, Landroidx/appcompat/widget/h0;->e()V
...
.method S()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;

    iget-object v1, v1, Landroidx/appcompat/widget/w;->u:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/w;->u:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;

    invoke-virtual {v2}, Landroid/widget/Spinner;->getPaddingRight()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;

    invoke-virtual {v3}, Landroid/widget/Spinner;->getWidth()I

    move-result v3

    iget-object v4, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;

    iget v5, v4, Landroidx/appcompat/widget/w;->t:I

    const/4 v6, -0x2

    if-ne v5, v6, :cond_3

    iget-object v5, p0, Landroidx/appcompat/widget/w$e;->X:Landroid/widget/ListAdapter;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;

    iget-object v6, v6, Landroidx/appcompat/widget/w;->u:Landroid/graphics/Rect;
    ...
    :goto_4
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/h0;->l(I)V
...
.method public T()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/w$e;->Z:I
...
.method U(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->Y:Landroid/graphics/Rect;
...
.method public i(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->W:Ljava/lang/CharSequence;
...
.method public k(I)V
    ...
    iput p1, p0, Landroidx/appcompat/widget/w$e;->Z:I
...
.method public m(II)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/h0;->h()Landroid/widget/ListView;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/w$e;->a0:Landroidx/appcompat/widget/w;
...
.method public o()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->W:Ljava/lang/CharSequence;
...
.method public p(Landroid/widget/ListAdapter;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->X:Landroid/widget/ListAdapter;
