...
# direct methods
.method constructor <init>(Landroid/content/Context;Lh0/d;Landroidx/emoji2/text/i$a;)V
    .locals 1
    ...
    invoke-static {p2, v0}, Lj0/h;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, p0, Landroidx/emoji2/text/i$b;->b:Lh0/d;
...
.method private e()Lh0/f$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/i$b;->b:Lh0/d;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/i$a;->b(Landroid/content/Context;Lh0/d;)Lh0/f$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, Lh0/f$a;->c()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Lh0/f$a;->b()[Lh0/f$b;
...
.method c()V
    ...
    :try_start_1
    invoke-direct {p0}, Landroidx/emoji2/text/i$b;->e()Lh0/f$b;

    move-result-object v0

    invoke-virtual {v0}, Lh0/f$b;->b()I
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/i$a;->a(Landroid/content/Context;Lh0/f$b;)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0}, Lh0/f$b;->d()Landroid/net/Uri;

    move-result-object v0

    invoke-static {v2, v3, v0}, Lb0/l;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
