...
.method public static a(Landroid/content/Context;Ll1/i;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->y()Ls1/h;

    move-result-object p1

    invoke-interface {p1, p2}, Ls1/h;->c(Ljava/lang/String;)Ls1/g;

    move-result-object v0

    if-eqz v0, :cond_0

    iget v0, v0, Ls1/g;->b:I
    ...
    invoke-virtual {p0, v0, v1, v2}, Lk1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-interface {p1, p2}, Ls1/h;->d(Ljava/lang/String;)V
...
.method private static b(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v2, p1, p2}, Lk1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public static c(Landroid/content/Context;Ll1/i;Ljava/lang/String;J)V
    .locals 2
    ...
    invoke-interface {v0, p2}, Ls1/h;->c(Ljava/lang/String;)Ls1/g;

    move-result-object v1

    if-eqz v1, :cond_0

    iget p1, v1, Ls1/g;->b:I
    ...
    invoke-direct {v1, p1}, Lt1/c;-><init>(Landroidx/work/impl/WorkDatabase;)V

    invoke-virtual {v1}, Lt1/c;->b()I

    move-result p1

    new-instance v1, Ls1/g;

    invoke-direct {v1, p2, p1}, Ls1/g;-><init>(Ljava/lang/String;I)V

    invoke-interface {v0, v1}, Ls1/h;->b(Ls1/g;)V
