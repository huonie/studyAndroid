...
.method constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->f()Lu1/a;
    ...
    invoke-direct {p3, p1, p2, v0}, Lo1/d;-><init>(Landroid/content/Context;Lu1/a;Lo1/c;)V

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lo1/d;
...
.method a()V
    ...
    invoke-interface {v0}, Ls1/q;->r()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lo1/d;
    ...
    iget-object v5, v4, Ls1/p;->a:Ljava/lang/String;

    invoke-virtual {v4}, Ls1/p;->a()J
    ...
    invoke-virtual {v4}, Ls1/p;->b()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lo1/d;

    invoke-virtual {v6, v5}, Lo1/d;->c(Ljava/lang/String;)Z
    ...
    iget-object v1, v1, Ls1/p;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v1, v5}, Lk1/j;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/c;->d:Lo1/d;

    invoke-virtual {v0}, Lo1/d;->e()V
