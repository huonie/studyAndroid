...
.method public constructor <init>(Landroid/content/Context;Lo3/g;)V
    ...
    iput-object p1, p0, Lpc/b;->p:Landroid/content/Context;

    iput-object p2, p0, Lpc/b;->q:Lo3/g;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lpc/b;->r:Ljava/util/List;

    return-void
.end method

.method public static synthetic v(Lpc/b;ILandroid/view/View;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lpc/b;->x(Lpc/b;ILandroid/view/View;)V

    return-void
.end method

.method private static final x(Lpc/b;ILandroid/view/View;)V
    .locals 0
    ...
    iget-object p2, p0, Lpc/b;->q:Lo3/g;

    if-eqz p2, :cond_0

    iget-object p0, p0, Lpc/b;->r:Ljava/util/List;
...
.method public c()I
    ...
    iget-object v0, p0, Lpc/b;->r:Ljava/util/List;
...
.method public bridge synthetic k(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lpc/b;->w(Lpc/c;I)V
...
.method public bridge synthetic m(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$d0;
    ...
    invoke-virtual {p0, p1, p2}, Lpc/b;->y(Landroid/view/ViewGroup;I)Lpc/c;
...
.method public w(Lpc/c;I)V
    ...
    invoke-virtual {p1}, Lpc/c;->N()Landroid/widget/ImageView;
    ...
    invoke-virtual {p1}, Lpc/c;->M()Landroid/widget/TextView;

    move-result-object v1

    iget-object v2, p0, Lpc/b;->p:Landroid/content/Context;
    ...
    invoke-direct {v0, p0, p2}, Lpc/a;-><init>(Lpc/b;I)V
...
.method public y(Landroid/view/ViewGroup;I)Lpc/c;
    .locals 3
    ...
    const-string v0, "from(parent.context).inf\u2026sult_item, parent, false)"

    invoke-static {p1, v0}, Lkb/h;->d(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {p2, p1}, Lpc/c;-><init>(Landroid/view/View;)V
