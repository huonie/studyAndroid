.class public final Lcom/lightqrcode/base/AppFileProvider$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/lightqrcode/base/AppFileProvider;
.end annotation
...
.method public synthetic constructor <init>(Lkb/f;)V
    ...
    invoke-direct {p0}, Lcom/lightqrcode/base/AppFileProvider$a;-><init>()V
...
.method private final e(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    .locals 8
    ...
    invoke-direct {p0, p2}, Lcom/lightqrcode/base/AppFileProvider$a;->h(Landroid/net/Uri;)Z
    ...
    :cond_0
    invoke-direct {p0, p2}, Lcom/lightqrcode/base/AppFileProvider$a;->g(Landroid/net/Uri;)Z
    ...
    invoke-direct {p0, p1, p2, v2, v2}, Lcom/lightqrcode/base/AppFileProvider$a;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    invoke-direct {p0, p2}, Lcom/lightqrcode/base/AppFileProvider$a;->i(Landroid/net/Uri;)Z
    ...
    :try_start_1
    invoke-direct {p0, p1, v0, v4, v5}, Lcom/lightqrcode/base/AppFileProvider$a;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final c(Landroid/content/Context;)Landroid/content/Context;
    ...
    const-string v0, "context.createDeviceProtectedStorageContext()"
...
.method public final d(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-direct {p0, p1, v1}, Lcom/lightqrcode/base/AppFileProvider$a;->a(Landroid/content/Context;Ljava/io/InputStream;)Ljava/io/File;
    ...
    :try_start_5
    invoke-direct {p0, p1, p2}, Lcom/lightqrcode/base/AppFileProvider$a;->e(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
...
.method public final f(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    invoke-virtual {p0, p1}, Lcom/lightqrcode/base/AppFileProvider$a;->c(Landroid/content/Context;)Landroid/content/Context;

    move-result-object p1

    const-string v0, "com.lightqrcode.fileprovider"

    invoke-static {p1, v0, p2}, Landroidx/core/content/b;->e(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;

    move-result-object p1

    const-string p2, "getUriForFile(getDeviceP\u2026text), AUTHORITIES, file)"
