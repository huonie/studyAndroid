...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lcom/google/firebase/remoteconfig/internal/c;->n:Lcom/google/firebase/remoteconfig/internal/c;
...
.method private constructor <init>(Ljava/util/concurrent/ExecutorService;Lcom/google/firebase/remoteconfig/internal/o;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/remoteconfig/internal/e;->c:Lm6/i;

    return-void
.end method

.method public static synthetic a(Lcom/google/firebase/remoteconfig/internal/e;Lcom/google/firebase/remoteconfig/internal/f;)Ljava/lang/Void;
    .locals 0
...
.method public static synthetic b(Lcom/google/firebase/remoteconfig/internal/e;ZLcom/google/firebase/remoteconfig/internal/f;Ljava/lang/Void;)Lm6/i;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/remoteconfig/internal/e;->j(ZLcom/google/firebase/remoteconfig/internal/f;Ljava/lang/Void;)Lm6/i;
...
.method private static c(Lm6/i;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<TResult:",
    ...
    invoke-virtual {p0, v1, v0}, Lm6/i;->f(Ljava/util/concurrent/Executor;Lm6/f;)Lm6/i;

    invoke-virtual {p0, v1, v0}, Lm6/i;->d(Ljava/util/concurrent/Executor;Lm6/e;)Lm6/i;

    invoke-virtual {p0, v1, v0}, Lm6/i;->a(Ljava/util/concurrent/Executor;Lm6/c;)Lm6/i;
...
.method public static declared-synchronized h(Ljava/util/concurrent/ExecutorService;Lcom/google/firebase/remoteconfig/internal/o;)Lcom/google/firebase/remoteconfig/internal/e;
    .locals 4
...
.method private synthetic i(Lcom/google/firebase/remoteconfig/internal/f;)Ljava/lang/Void;
    ...
    invoke-virtual {v0, p1}, Lcom/google/firebase/remoteconfig/internal/o;->e(Lcom/google/firebase/remoteconfig/internal/f;)Ljava/lang/Void;
...
.method private synthetic j(ZLcom/google/firebase/remoteconfig/internal/f;Ljava/lang/Void;)Lm6/i;
    .locals 0
    ...
    :cond_0
    invoke-static {p2}, Lm6/l;->e(Ljava/lang/Object;)Lm6/i;
...
.method public d()V
    ...
    iput-object v0, p0, Lcom/google/firebase/remoteconfig/internal/e;->c:Lm6/i;
...
.method public declared-synchronized e()Lm6/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/e;->c:Lm6/i;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lm6/i;->o()Z
    ...
    invoke-direct {v2, v1}, Lcom/google/firebase/remoteconfig/internal/b;-><init>(Lcom/google/firebase/remoteconfig/internal/o;)V

    invoke-static {v0, v2}, Lm6/l;->c(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lm6/i;
...
.method g(J)Lcom/google/firebase/remoteconfig/internal/f;
    ...
    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/e;->c:Lm6/i;
    ...
    :try_start_1
    invoke-virtual {p0}, Lcom/google/firebase/remoteconfig/internal/e;->e()Lm6/i;

    move-result-object v0

    sget-object v1, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-static {v0, p1, p2, v1}, Lcom/google/firebase/remoteconfig/internal/e;->c(Lm6/i;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
...
.method public k(Lcom/google/firebase/remoteconfig/internal/f;)Lm6/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/firebase/remoteconfig/internal/e;->l(Lcom/google/firebase/remoteconfig/internal/f;Z)Lm6/i;
...
.method public l(Lcom/google/firebase/remoteconfig/internal/f;Z)Lm6/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/firebase/remoteconfig/internal/a;-><init>(Lcom/google/firebase/remoteconfig/internal/e;Lcom/google/firebase/remoteconfig/internal/f;)V
